...
def main(access_token):
    ...
    with open(
        r"F:\OneDrive - Centaurioun\ScientificRadar\articles\Sun-corona\scientific_terms.txt",
        "r",
        encoding="utf-8",
    ) as file:
    ...
    with open(
        r"F:\OneDrive - Centaurioun\ScientificRadar\articles\Sun-corona\article.txt",
        "r",
        encoding="utf-8",
    ) as file:
        content = file.read()
