...
def main(access_token):
    ...
    with open(
        r"F:\OneDrive - Centaurioun\ScientificRadar\articles\Supercapacitors\scientific_terms.txt",
        "r",
        encoding="utf-8",
    ) as file:
    ...
    with open(
        r"F:\OneDrive - Centaurioun\ScientificRadar\articles\Supercapacitors\article.txt",
        "r",
        encoding="utf-8",
    ) as file:
        content = file.read()
